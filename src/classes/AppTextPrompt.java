 ...
 *  class construction.
 */
public class AppTextPrompt extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public AppTextPrompt(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public AppTextPrompt(String text, JTextComponent component, Show show)
	{
